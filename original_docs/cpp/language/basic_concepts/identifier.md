...
CWG 1440	C++11	decltype expressions preceding :: could denote any type	can only denote class
or enumeration types
CWG 1963	C++11	implementation-defined characters other than digits, non-digits
...
CWG 2777	C++20	the type of an identifier expression was unclear
